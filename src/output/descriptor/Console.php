...
namespace sower\console\output\descriptor;

use sower\Console as SowerCos;
...
class Console
{
    ...
    /**
     * 构造方法
     * @param SowerCos $console
     * @param string|null  $namespace
     */
    public function __construct(SowerCos $console, $namespace = null)
    {
